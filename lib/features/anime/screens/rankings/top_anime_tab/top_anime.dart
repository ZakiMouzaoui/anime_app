import 'package:anime_app/features/controllers/rankings/top_anime_controller.dart';
...
class TopAnimeTab extends StatelessWidget {
  const TopAnimeTab({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(TopAnimeController());

...
import 'package:anime_app/features/controllers/rankings/top_airing_controller.dart';
...
class TopAiringTab extends StatelessWidget {
  const TopAiringTab({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(TopAiringController());
